...
function usage() {
    ...
    echo ""
    echo "Usage: $0 -i|--input-file -l|--log-directory -d|--delete -v|--verify -d|--delete -c|--create " 1>&2
    echo ""
    ...
    echo " -d | --delete               Optional    delete the resource group if it already exists"
...
function parseInput() {
    ...
    local OPTIONS=i:l:dvdc
    local LONGOPTS=input-file:,log-directory:,delete,verify,delete,create
